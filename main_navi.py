...
def main():
    ...
    # to edit with testing
        ...
        "Becker Amphitheater": {"Visual Arts": 1.5, "Commons": 1},
        ...
        "Nutwood Parking Structure": {"Dan Black Hall": 2, "Art 01": 1},
        "Parking A": {"A-South Parking": 1.5, "Parking & Transportation Office": 1.5, "Children's Center": 1.25},
        "Parking C": {"Mihaylo Hall": 3, "NutWood 01": .5},
        "Parking E": {},
        ...
        "Titan Student Union": { "Golleher Alumni House": 1, "State College Parking": 1.5, "Student Rec Center": 1.5, "Visual Arts": 1},
